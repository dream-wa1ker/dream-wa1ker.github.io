...
<div class="profile-block">
  ...
  <div class="profile-name">dream-wa1ker</div>
</div>
...
<section>
  ...
  <div class="see-also">
    <ul>
      <li><span class="label">contact(1)</span><a href="{{ '/contact/' | relative_url }}">reach me</a></li>
      <li><span class="label">whoami(1)</span><a href="{{ '/whoami/' | relative_url }}">itz me</a></li>
      <li><span class="label">projects(1)</span><a href="{{ '/projects/' | relative_url }}">make build</a></li>
    </ul>
  </div>
</section>
